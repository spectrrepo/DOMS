...
@section('profile-content')
    ...
    {{ Form::open(['class' => 'uk-form uk-form-horizontal', 'method' => 'post', 'route' => ['editPlace', $placement->id], 'files' => true]) }}
            ...
            <div class="uk-margin uk-width-1-2">
                <div class="uk-width-1-1 uk-margin text-center">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-width-1-1" type="text" name="title" value="{{ $placement->title }}">
                        </div>
                    </div>
                </div>
                <div class="uk-width-1-1 uk-margin text-center">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <textarea class="uk-width-1-1" name="description">{{ $placement->description }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <div id="main-wrap-photo" class="wrap-main-dwnld-photo" title="Добавить изображение">
                                ...
                                <span>
                                    <img class="img-full-width" src="{{ Storage::url($placement->img_middle) }}">
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="uk-width-1-1 uk-margin">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <textarea id="full_description" name="full_description">{{ $placement->full_description }}</textarea>
