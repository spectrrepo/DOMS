...
@section('profile-content')
    <h3 class="liked-title margin-bottom-10">Добавить помещение</h3>
    @include('profile.elements.validate')
    {{ Form::open(['class' => 'uk-form uk-form-horizontal', 'method' => 'post', 'route' => ['addPlace'], 'files' => true]) }}
            ...
            <div class="uk-margin uk-width-1-2">
                ...
                <div class="uk-width-1-1 uk-margin text-center">
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            <textarea class="uk-width-1-1" name="description"></textarea>
                        </div>
                    </div>
                </div>
