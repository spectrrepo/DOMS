...
{{ Form::open(array('url' => '/add_styles', 'files' => 'true'))}}
  <input class="title-add-news" type="text" name="title" placeholder="название стиля">
  ...
  <textarea class="min-description-news" name="description" placeholder="описание стиля"></textarea>
